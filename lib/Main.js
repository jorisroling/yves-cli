    ...
    Main.prototype.doProcess = function (object) {
      ...
      if (self.options.query) {
        if (Array.isArray(object)) {
          ...
          console.log(`Data is not of type array (but of type ${typeof object}), so query is not possible`)
          return '';
        }
      }
      ...
      if (self.options.fields) {
        if (Array.isArray(object)) {
          ...
          console.log(`Data is not of type array (but of type ${typeof object}), so fields is not possible`)
          return '';
        }
      }
